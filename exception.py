class OriginalException:
    ...
    def main(self, taget_df, personal_exception, w_e,taget_dir):
        except_words = self.except_words_folder(taget_df,taget_dir)
        except_words =\
    ...
    def except_words_folder(self, target_df, taget_dir):
        if taget_dir == 0:
